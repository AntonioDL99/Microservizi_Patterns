...
import com.patterns.webflux.sec04.dto.InventoryResponse;
...
public class InventoryClient {
    ...
    private InventoryResponse buildErrorResponse(InventoryRequest request) {
        return InventoryResponse.create(null, request.getQuantity(), request.getQuantity(), null, Status.FAILED);
    }
