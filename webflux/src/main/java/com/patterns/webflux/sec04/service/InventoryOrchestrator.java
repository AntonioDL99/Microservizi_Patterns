...
import com.patterns.webflux.sec04.client.InventoryClient;
...
public class InventoryOrchestrator extends Orchestrator {
    ...
    public Predicate<OrchestrationRequestContext> isSuccess() {
        return ctx -> Objects.nonNull(ctx.getInventoryResponse())
                && Status.SUCCESS.equals(ctx.getInventoryResponse().getStatus());
    }
